...
#define GET_1_Value(num, seed1, seed2, flow_size) \
action get_pipe##num (inout metadata meta, inout bit<32> flow_size){\
hash(meta.currentIndex, HashAlgorithm.crc32, (bit<32>)0, {meta.original_flowID, seed1}, (bit<32>)ENTRIES_PER_TABLE);\
...
if (meta.original_flowID - meta.currentKey == 0) {\
    ...
    hash(meta.currentIndex, HashAlgorithm.crc32, (bit<32>)0, {meta.original_flowID, seed2}, (bit<32>)ENTRIES_PER_TABLE);\
    hp##num.read(meta.currentEntry_s, meta.currentIndex);\
    meta.currentTimestamp = meta.currentEntry_s[183:136];\
    meta.currentKey = meta.currentEntry_s[135:32];\
    meta.currentCount = meta.currentEntry_s[31:0];\
...
control Measurement(inout headers hdr,
    ...
    STAGE_1(0, 104w00000000000000000000, 104w78787878878787787887)
    STAGE_N(1, 104w11111111111111111111)

    STAGE_1(2, 104w22222222222222222222, 104w87878787878787878787)
    STAGE_N(3, 104w33333333333333333333)

    STAGE_1(4, 104w44444444444444444444, 104w98989898989898989899)
    STAGE_N(5, 104w55555555555555555555)

    STAGE_1(6, 104w66666666666666666666, 104w55656565655656656565)
    STAGE_N(7, 104w77777777777777777777)
    
    STAGE_1(8, 104w88888888888888888888, 104w45554544545454545444)
    STAGE_N(9, 104w99999999999999999999)


    GET_1_Value(0, 104w00000000000000000000, 104w78787878878787787887, flow_size)
    GET_Value(1, 104w11111111111111111111, flow_size)
    
    GET_1_Value(2, 104w22222222222222222222, 104w87878787878787878787, flow_size)
    GET_Value(3, 104w33333333333333333333, flow_size)

    GET_1_Value(4, 104w44444444444444444444, 104w98989898989898989899, flow_size)
    GET_Value(5, 104w55555555555555555555, flow_size)
    
    GET_1_Value(6, 104w66666666666666666666, 104w55656565655656656565, flow_size)
    GET_Value(7, 104w77777777777777777777, flow_size)

    GET_1_Value(8, 104w88888888888888888888, 104w45554544545454545444, flow_size)
