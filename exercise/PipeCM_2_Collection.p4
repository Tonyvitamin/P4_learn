...
// First pipe-sketch
register<bit<105>> (ENTRIES_PER_TABLE) Flow_ID_0;
register<bit<32>> (ENTRIES_PER_TABLE) Counter_0;

register<bit<105>> (ENTRIES_PER_TABLE) Flow_ID_1;
register<bit<32>> (ENTRIES_PER_TABLE) Counter_1;

register<bit<105>> (ENTRIES_PER_TABLE) Flow_ID_2;
...
WRITE_FLOWID(num, meta.toWriteKey);\
