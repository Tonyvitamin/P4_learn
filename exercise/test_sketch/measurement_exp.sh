...
do 
    ...
    /bin/bash ./s2_read_timestamp.sh  | sed '1,3d' | sed '2,5d' | awk '{print $1 $2}' >> s2_timestamp.txt
    ...
    /bin/bash ./s1_read_estimate.sh  | sed '1,3d' | sed '2,5d' | awk '{print $1 $2}' >> s1_estimate.txt
